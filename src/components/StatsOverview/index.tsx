  ...
  return (
    <div className="grid grid-cols-3 md:grid-cols-6 gap-4">
      <div className="bg-white rounded-lg shadow-md p-4">
        ...
        <div className="text-gray-800 font-bold text-lg">{totalBets}</div>
      </div>
      <div className="bg-white rounded-lg shadow-md p-4">
        <div className="text-gray-600 text-sm">Win Rate</div>
        <div className="text-gray-800 font-bold text-lg">{formatPercentage(winRate)}</div>
      </div>
      <div className="bg-white rounded-lg shadow-md p-4">
        <div className="text-gray-600 text-sm">Net P&L</div>
        <div className={`text-gray-800 font-bold text-lg ${netPnLColor}`}>{formatCurrency(netPnL)}</div>
      </div>
      <div className="bg-white rounded-lg shadow-md p-4">
        <div className="text-gray-600 text-sm">ROI</div>
        <div className={`text-gray-800 font-bold text-lg ${roiColor}`}>{formatPercentage(roi)}</div>
      </div>
      <div className="bg-white rounded-lg shadow-md p-4">
        <div className="text-gray-600 text-sm">Current Streak</div>
        <div className={`text-gray-800 font-bold text-lg ${streakColor}`}>{streakText}</div>
      </div>
      <div className="bg-white rounded-lg shadow-md p-4">
        <div className="text-gray-600 text-sm">Average Odds</div>
        <div className="text-gray-800 font-bold text-lg">{formatOdds(averageOdds)}</div>
      </div>
    </div>
  );
}
